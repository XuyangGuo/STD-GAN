...
class ResBlocks(nn.Module):
    ...
    def __init__(self, num_blocks, dim, norm='in', activation='relu', pad_type='zero', bias=True, norm_affine=False,
                 activation2='none'):
        super(ResBlocks, self).__init__()
        self.model = []
        for i in range(num_blocks):
            self.model += [ResBlock(dim, norm=norm, activation=activation, pad_type=pad_type, bias=bias,
                                    norm_affine=norm_affine, activation2=activation2)]
...
class ResBlock(nn.Module):
    ...
    def __init__(self, dim, norm='in', activation='relu', pad_type='zero', bias=True, norm_affine=False,
                 activation2='none'):
        super(ResBlock, self).__init__()

        model = []
        model += [Conv2dBlock(dim, dim, 3, 1, 1, norm=norm, activation=activation, pad_type=pad_type, use_bias=bias,
                              norm_affine=norm_affine)]
        model += [Conv2dBlock(dim, dim, 3, 1, 1, norm=norm, activation=activation2, pad_type=pad_type, use_bias=bias,
                              norm_affine=norm_affine)]
...
class LinearBlock(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, norm='none', activation='relu', use_bias=True, leaky_slope=0.2):
